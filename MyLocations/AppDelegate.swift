...
//  MyLocations
//
//  Created by Mario D'Ambros Filho on 24/11/16.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        if let tabBarViewControllers = tabBarController.viewControllers {
            let currentViewController = tabBarViewControllers.first as! CurrentLocationViewController
            currentViewController.managedObjectContext = managedObjectContext
            
            let navigationController = tabBarViewControllers[1] as! UINavigationController
            let locationsViewController = navigationController.viewControllers.first as! LocationsViewController
        ...
        listerForFatalCoreDataNotifications()
        return true
    }
    ...
    func listerForFatalCoreDataNotifications() {

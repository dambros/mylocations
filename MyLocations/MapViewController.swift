...
//  MyLocations
//
//  Created by Mario D'Ambros Filho on 29/11/16.
...
//                        if let s = dictionary["inserted"] as? Set<Location> {
//                            locations += s
//                        }
//                        if let s = dictionary["deleted"] as? Set<Location> {
//                            locations += s
//                        }
//                        if let s = dictionary["updated"] as? Set<Location>{
//                            locations += s
//                        }
//                    }
